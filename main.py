...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    conv_layer7 = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, 1, kernel_initializer=tf.random_normal_initializer(stddev=0.01))

    deconv1 = tf.layers.conv2d_transpose(conv_layer7, num_classes, (4,4), (2,2), 'SAME', kernel_initializer=tf.random_normal_initializer(stddev=0.01))
    conv_layer4 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1, 1, kernel_initializer=tf.random_normal_initializer(stddev = 0.01))
    skip_dec1_lay4 = tf.add(deconv1, conv_layer4)

    deconv2 = tf.layers.conv2d_transpose(skip_dec1_lay4, num_classes, (4,4), (2,2), 'SAME', kernel_initializer=tf.random_normal_initializer(stddev=0.01))
    conv_layer3 = tf.layers.conv2d(vgg_layer3_out, num_classes, 1, 1, kernel_initializer=tf.random_normal_initializer(stddev = 0.01))
    skip_dec2_lay3 = tf.add(deconv2, conv_layer3)

    deconv3 = tf.layers.conv2d_transpose(skip_dec2_lay3, num_classes, (16,16), (8,8), 'SAME', kernel_initializer=tf.random_normal_initializer(stddev=0.01))    
